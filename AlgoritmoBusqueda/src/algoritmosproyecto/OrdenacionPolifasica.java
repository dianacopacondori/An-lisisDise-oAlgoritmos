...
public class OrdenacionPolifasica {
    ...
    public static void mezclarPolifasico(List<File> corridas, File archivoSalida) throws IOException {
    ...
    public static void ordenar(File archivoEntrada, File archivoSalida, int tamBloque) throws IOException {
        List<File> corridas = generarCorridas(archivoEntrada, tamBloque);
        mezclarPolifasico(corridas, archivoSalida);
    }
}
